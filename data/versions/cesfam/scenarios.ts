...
export const scenarios: ScenarioFile = {
  ...
  scenarios: [
    ...
    },
    {
      ...
      stakeholderId: 'sofia-castro',
      stakeholderRole: 'Asistente Administrativa',
      dialogue: 'Primer tope critico: Lunes AM en el Box 5. Andres Guzman lo deja para su bloque clinico, pero Eduardo Naranjo aparece agendado en el mismo box para el Sector Rojo. Si no lo corrige, el lunes parten peleando el espacio.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '➡️', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
    ...
    },
    {
      ...
      stakeholderId: 'sofia-castro',
      stakeholderRole: 'Asistente Administrativa',
      dialogue: 'Y tercero: Viernes AM en el Box 3. Paz Herrera y Javier Castro quedaron al mismo tiempo en el mismo box. El Sector Azul no tiene margen para absorber otro error de coordinacion interna.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '➡️', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
      ...
      options: [
        {
          ...
          cardEmoji: '🔵',
          text: 'Ire a ver al Dr. Guzman. Entre el Box 5 del lunes y el cruce del viernes, el Sector Azul ya tiene dos problemas abiertos.',
          tags: { ethics_level: 'convencional' },
          consequences: {
            trustChange: 0,
            supportChange: 0,
        ...
        },
        {
          ...
          cardEmoji: '🟡',
          text: 'Ire con Daniel Rios. Si el Sector Amarillo sigue empujando box compartidos a mitad de semana, el resto del tablero se va a seguir desordenando.',
          tags: { ethics_level: 'postconvencional' },
          consequences: {
            trustChange: 0,
            supportChange: 0,
            ...
            expected_actions: [
              {
                ...
                ui: {
                  title: 'Mantener a Javier Castro con el Sector Azul - Lunes AM',
                },
                effects: {
    ...
    },
    {
      ...
      dialogue: 'Director, menos mal que vino a ver la trinchera. Ya debe saber que la agenda esta ardiendo, pero aqui no estamos peleando por egos academicos ni por auditorias de escritorio. Estamos peleando por la gente.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '➡️', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
    ...
    },
    {
      ...
      stakeholderRole: 'Jefe Sector Amarillo',
      participantIds: ['francisca-solis', 'ricardo-meza'],
      dialogue: 'La otra pelea es el lunes en la mañana. Tenemos operativo en terreno con postrados y vacunacion, y nos faltan manos. Si Javier Castro no sale con nosotros, el despliegue queda cojo desde la primera visita.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '➡️', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
