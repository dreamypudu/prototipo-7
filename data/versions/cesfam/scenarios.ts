...
export const scenarios: ScenarioFile = {
  ...
  scenarios: [
      ...
      options: [
        {
          ...
          cardEmoji: '🏛️',
          text: 'Comparto su diagnostico, doctor. La conducta de Daniel Rios no se puede validar. Voy a empujar una respuesta administrativa dura para restablecer el orden.',
          tags: { ethics_level: 'convencional' },
          consequences: {
            trustChange: 15,
            supportChange: 10,
            reputationChange: 5,
            dialogueResponse: 'Una decision lucida. El centro necesita demostrar que todavia existe autoridad. Estare atento a que esa firmeza no se diluya ma?ana.',
            expected_actions: [
              {
                mechanic_id: 'admin',
                action_type: 'issue_summary',
      ...
      options: [
        {
          ...
          consequences: {
            ...
            supportChange: 5,
            reputationChange: 5,
            dialogueResponse: 'Sabia que usted entendia la calle, Director. Si pone ese limite con criterio, yo puedo sostener al equipo y bajar la temperatura del sector.',
            expected_actions: [
              {
                mechanic_id: 'admin',
        ...
        },
        {
          ...
          cardTitle: 'Suspender decision',
          cardEmoji: '\u23F3',
          text: 'No voy a tomar una decision en caliente. Romper protocolos de farmacia es grave, aunque la urgencia tambien lo sea. Primero voy a revisar todos los antecedentes.',
          tags: { ethics_level: 'preconvencional' },
          consequences: {
            trustChange: -5,
            supportChange: 0,
    ...
    },
    {
      ...
      stakeholderId: 'sofia-castro',
      stakeholderRole: 'Asistente Administrativa',
      dialogue: 'Director, se acabo el tiempo. Son las 16:30 y el plazo administrativo para dar curso o rechazar la denuncia formal de Marcela Soto vence en media hora.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '\u27A1\uFE0F', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
      ...
      stakeholderId: 'sofia-castro',
      stakeholderRole: 'Asistente Administrativa',
      dialogue: 'Tengo la resolucion impresa en su escritorio. Si usted aprueba el sumario, Daniel Rios sera suspendido de sus funciones de jefatura mientras dure la investigacion. Si usted lo rechaza, Marcela Soto quedara desautorizada frente a todo el Centro de Salud.',
      options: [{ option_id: 'NEXT', cardTitle: 'Siguiente', cardEmoji: '\u27A1\uFE0F', text: 'Siguiente', tags: {}, consequences: { dialogueResponse: '' } }],
    },
    {
      ...
      options: [
        {
          ...
          consequences: {
            ...
            supportChange: 0,
            reputationChange: 0,
            dialogueResponse: 'Entendido. Ingresare el documento al sistema ahora mismo. Preparese para la reaccion del Sector Amarillo manana.',
          },
        },
        {
          option_id: 'B',
