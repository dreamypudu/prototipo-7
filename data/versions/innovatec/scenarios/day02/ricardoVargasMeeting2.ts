...
export const nodes: ScenarioNode[] = [
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Siguiente", cardEmoji: "➡️", text: "Lo reportaré como 'Completo'. Es funcional, como dice el equipo. Optimizaremos la estabilidad en el siguiente ciclo.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -15, supportChange: 5, projectProgressChange: 5, bridgeResponse: "Entiendo, priorizas el flujo de caja y la percepción. Es una estrategia. Sigamos..." } },
          ...
          { option_id: "C", cardTitle: "Criterio Etico Amplio", cardEmoji: "🧭", text: "Lo reportaré como 'Completo con Salvedades Técnicas', adjuntando un anexo con los logs de errores y un plan de acción. La transparencia es total.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 15, supportChange: 0, bridgeResponse: "Una postura apegada a la realidad, aunque sea dolorosa financieramente. Lo valoro. Sigamos..." } },
          { option_id: "D", cardTitle: "Definir Reporte", cardEmoji: "📊", text: "Te lo comento a ti 'off the record', pero en el informe oficial para la gerencia irá como 'Completo' para no generar alarmas innecesarias.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -20, supportChange: 10, projectProgressChange: 5, bridgeResponse: "Entiendo, priorizas el flujo de caja y la percepción. Es una estrategia. Sigamos..." } }
        ]
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Ajuste Presupuestario", cardEmoji: "💰", text: "Es un golpe de suerte. Lo consideraremos un ahorro y lo reasignaremos al fondo de contingencia del proyecto.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -10, budgetChange: 15000, bridgeResponse: "Una decisión puramente financiera. Anotado. Pasemos al último punto..." } },
          { option_id: "B", cardTitle: "Ajuste Presupuestario", cardEmoji: "💰", text: "Es dinero que no nos corresponde. Debemos contactarlos y pagar la diferencia. Nuestra integridad como empresa vale más que 15k.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 15, supportChange: 5, bridgeResponse: "Honesto. Cuesta dinero, pero entiendo el principio. Pasemos al último punto..." } },
          { option_id: "C", cardTitle: "Aplicar Protocolo", cardEmoji: "📘", text: "La política de la empresa nos exige verificar y pagar las facturas correctas. Hay que informar del error.", tags: { "ethics_kohlberg": "conventional" }, consequences: { trustChange: 10, supportChange: 0, bridgeResponse: "Honesto. Cuesta dinero, pero entiendo el principio. Pasemos al último punto..." } },
          { option_id: "D", cardTitle: "Ajuste Presupuestario", cardEmoji: "💰", text: "No hagamos nada por ahora. Si ellos lo descubren y nos contactan, pagaremos. Si no, el ahorro es nuestro.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -15, budgetChange: 15000, bridgeResponse: "Una decisión puramente financiera. Anotado. Pasemos al último punto..." } }
        ]
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Asignar Recursos", cardEmoji: "🧩", text: "Mi proyecto es la prioridad estratégica N°1. No puedo ceder a Laura en esta fase crítica.", tags: { "risk": "high" }, consequences: { trustChange: -20, supportChange: -15, bridgeResponse: "OK." } },
          { option_id: "B", cardTitle: "Resolver Conflicto", cardEmoji: "🤝", text: "El ingreso de ese contrato es más importante. Cederé a Laura y mi equipo absorberá el retraso como pueda.", tags: { "risk": "low" }, consequences: { trustChange: 15, supportChange: 10, projectProgressChange: -5, bridgeResponse: "OK." } },
          { option_id: "C", cardTitle: "Decision de Riesgo Medio", cardEmoji: "🟡", text: "Laura puede trabajar para ellos, pero solo medio día. Afectará a ambos, pero ninguno se detendrá por completo.", tags: { "risk": "medium" }, consequences: { trustChange: 5, supportChange: 0, projectProgressChange: -2, bridgeResponse: "OK." } },
          { option_id: "D", cardTitle: "Decision de Riesgo Medio", cardEmoji: "🟡", text: "La cederé, pero con una condición: que la Gerencia apruebe formalmente el nuevo cronograma de mi proyecto y ajuste las expectativas de entrega.", tags: { "risk": "medium" }, consequences: { trustChange: 10, supportChange: 5, projectProgressChange: -5, bridgeResponse: "OK." } }
        ]
      },
];
