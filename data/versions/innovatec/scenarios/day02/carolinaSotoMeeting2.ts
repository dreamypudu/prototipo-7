...
export const nodes: ScenarioNode[] = [
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Criterio Pragmatico", cardEmoji: "⚡", text: "Omitimos ese feedback. Es demasiado temprano y solo generará dudas. Nos enfocamos en los aspectos positivos.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -10, supportChange: -5, reputationChange: -5, bridgeResponse: "Entendido, control de daños. A veces hay que maquillar la verdad para proteger el proyecto. Sigamos..." } },
          { option_id: "B", cardTitle: "Aplicar Protocolo", cardEmoji: "📘", text: "Presentamos todos los resultados, textuales y sin filtro, tal como lo exige la política de reportes de la empresa.", tags: { "ethics_kohlberg": "conventional" }, consequences: { trustChange: 5, supportChange: -10, reputationChange: -10, bridgeResponse: "Transparencia total. Es un enfoque valiente, espero que no nos disparemos en el pie. Sigamos..." } },
          { option_id: "C", cardTitle: "Criterio Etico Amplio", cardEmoji: "🧭", text: "Lo presentamos como un hallazgo valioso que nos permite mejorar. Seremos transparentes con la crítica y mostraremos un plan de acción inmediato para solucionarlo.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 15, supportChange: 5, reputationChange: 5, bridgeResponse: "Transparencia total. Es un enfoque valiente, espero que no nos disparemos en el pie. Sigamos..." } },
          { option_id: "D", cardTitle: "Definir Reporte", cardEmoji: "📊", text: "Resaltamos los pocos comentarios positivos en el cuerpo del informe y enterramos los datos negativos en un anexo técnico.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -15, supportChange: -10, reputationChange: -10, bridgeResponse: "Entendido, control de daños. A veces hay que maquillar la verdad para proteger el proyecto. Sigamos..." } }
        ]
      },
  {
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Aplicar Protocolo", cardEmoji: "📘", text: "Debe ser despedido. La política de la empresa sobre filtraciones es de tolerancia cero.", tags: { "ethics_kohlberg": "conventional" }, consequences: { trustChange: -10, reputationChange: 5, bridgeResponse: "Ok, entiendo tu postura." } },
          { option_id: "B", cardTitle: "Resolver Conflicto", cardEmoji: "🤝", text: "Fue un error de novato, sin mala intención. Hay que hablar con él, emitir una advertencia formal y usarlo como caso de estudio para el resto del equipo.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 15, supportChange: 5, reputationChange: -5, bridgeResponse: "Ok, entiendo tu postura." } },
          { option_id: "C", cardTitle: "Resolver Conflicto", cardEmoji: "🤝", text: "Digámosle que borre el post y hagamos como si nada. No necesitamos un escándalo de RRHH. Un susto será suficiente castigo.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -15, reputationChange: -10, bridgeResponse: "Ok, entiendo tu postura." } },
          { option_id: "D", cardTitle: "Criterio Pragmatico", cardEmoji: "⚡", text: "La imagen es lo primero. Dependiendo de la reacción online, o lo despedimos para mostrar mano dura, o lo ignoramos si a nadie le importa.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -20, reputationChange: -15, bridgeResponse: "Ok, entiendo tu postura." } }
        ]
      },
];
