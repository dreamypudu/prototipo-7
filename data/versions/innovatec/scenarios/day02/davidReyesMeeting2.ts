...
export const nodes: ScenarioNode[] = [
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Criterio Pragmatico", cardEmoji: "⚡", text: "Diles que son profesionales y que deben dejar sus problemas personales en casa. Si no pueden, uno de los dos tendrá que irse.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -20, supportChange: -15, bridgeResponse: "Es una solución... funcional, supongo. Pero no resuelve el problema de fondo. Lo implementaré. Continuemos..." } },
          { option_id: "B", cardTitle: "Aplicar Protocolo", cardEmoji: "📘", text: "RRHH tiene un protocolo de mediación de conflictos. Inicia el procedimiento formal con ellos de inmediato.", tags: { "ethics_kohlberg": "conventional" }, consequences: { trustChange: 5, supportChange: 0, bridgeResponse: "Ok, seguir el protocolo. Es el camino correcto, aunque lento. Informaré a RRHH. Continuemos..." } },
          { option_id: "C", cardTitle: "Criterio Etico Amplio", cardEmoji: "🧭", text: "Esto es mi responsabilidad. Quiero que organices una reunión conmigo y con cada uno de ellos por separado. Necesito entender qué pasa antes de tomar cualquier medida.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 20, supportChange: 15, bridgeResponse: "Gracias. Aprecio que te involucres a ese nivel. Creo que es el enfoque correcto para el equipo. Coordinaré las reuniones..." } },
          { option_id: "D", cardTitle: "Criterio Pragmatico", cardEmoji: "⚡", text: "Reasígnalos a módulos diferentes del proyecto para que no tengan que interactuar. Es la forma más rápida de solucionar el bloqueo.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -15, supportChange: -10, bridgeResponse: "Es una solución... funcional, supongo. Pero no resuelve el problema de fondo. Lo implementaré. Continuemos..." } }
        ]
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Gestionar Riesgo", cardEmoji: "🛡️", text: "La seguridad es la máxima prioridad. Paren lo que están haciendo y dediquen la semana a la solución completa.", tags: { "risk": "low" }, consequences: { trustChange: 15, supportChange: 10, projectProgressChange: -3, bridgeResponse: "Decisión clara. Notificaré al equipo que re-priorizamos todo. Es lo más seguro. Último punto..." } },
          { option_id: "B", cardTitle: "Rechazar Propuesta", cardEmoji: "⛔", text: "El riesgo es 'medio', no 'crítico'. Apliquen el parche rápido y sigamos adelante. No podemos parar por todo.", tags: { "risk": "high" }, consequences: { trustChange: -15, supportChange: -10, bridgeResponse: "Entendido. Parche rápido. Documentaremos que esta es una solución temporal bajo tu dirección. Último punto..." } },
          { option_id: "C", cardTitle: "Gestionar Riesgo", cardEmoji: "🛡️", text: "Apliquen el parche ahora para estar cubiertos, pero creen una tarea en el backlog con alta prioridad para implementar la solución completa en el próximo sprint.", tags: { "risk": "medium" }, consequences: { trustChange: 5, supportChange: 5, bridgeResponse: "Un enfoque medido. Me parece razonable. Actuar ahora pero planificar a largo plazo. De acuerdo. Último punto..." } },
          { option_id: "D", cardTitle: "Definir Reporte", cardEmoji: "📊", text: "Necesito más datos. Prepara un informe de una página que evalúe el peor escenario posible si esta vulnerabilidad es explotada. Decidiré con esa información.", tags: { "risk": "medium" }, consequences: { trustChange: 5, supportChange: 0, bridgeResponse: "Un enfoque medido. Me parece razonable. Actuar ahora pero planificar a largo plazo. De acuerdo. Último punto..." } }
        ]
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Resolver Conflicto", cardEmoji: "🤝", text: "Dile a Ana que haga lo que pide Carolina. No quiero un conflicto con Marketing, son un área muy influyente.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -20, supportChange: -15, reputationChange: -5, bridgeResponse: "Ok." } },
          { option_id: "B", cardTitle: "Criterio Normativo", cardEmoji: "📘", text: "Esto es una violación de los procesos. Hablaré directamente con Carolina y le recordaré que todas las solicitudes deben pasar por nuestra planificación de sprints.", tags: { "ethics_kohlberg": "conventional" }, consequences: { trustChange: 10, supportChange: 5, bridgeResponse: "Ok." } },
          { option_id: "C", cardTitle: "Resolver Conflicto", cardEmoji: "🤝", text: "Yo te respaldo. Habla tú con Ana y dile que su prioridad es el sprint que definimos. Yo me encargaré de la conversación con Carolina para buscar una solución que respete a nuestro equipo.", tags: { "ethics_kohlberg": "post-conventional" }, consequences: { trustChange: 20, supportChange: 15, bridgeResponse: "Ok." } },
          { option_id: "D", cardTitle: "Criterio Pragmatico", cardEmoji: "⚡", text: "Dile a Ana que ignore el correo de Carolina por ahora. Si vuelve a insistir, le diremos que estamos demasiado ocupados.", tags: { "ethics_kohlberg": "pre-conventional" }, consequences: { trustChange: -10, supportChange: -10, bridgeResponse: " " } }
        ]
      },
];
