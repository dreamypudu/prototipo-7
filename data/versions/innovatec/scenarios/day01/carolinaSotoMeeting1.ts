...
export const nodes: ScenarioNode[] = [
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Aplicar Protocolo", cardEmoji: "📘", text: "Técnicamente es muy complejo y la ley de protección de datos lo hace demasiado riesgoso. Descartémoslo por ahora.", tags: { "risk": "low" }, consequences: { trustChange: -5, supportChange: -10, bridgeResponse: "Siempre posponiendo... Entiendo la cautela, pero la oportunidad se nos puede escapar de las manos. Sigamos..." } },
          { option_id: "B", cardTitle: "Decision de Alto Riesgo", cardEmoji: "🔴", text: "Es una idea poderosa. La agrego al alcance del proyecto. Asumiremos el desafío técnico y legal.", tags: { "risk": "high" }, consequences: { trustChange: 10, supportChange: 15, projectProgressChange: 5, bridgeResponse: "¡Excelente! Visión de futuro. Sabía que verías el potencial. Mi equipo estará feliz de colaborar en eso. Próximo tema..." } },
          { option_id: "C", cardTitle: "Buscar Equilibrio", cardEmoji: "⚖️", text: "Propongo un piloto muy pequeño y controlado con un grupo de clientes que nos den su consentimiento explícito para un estudio. Así medimos el valor sin exponernos.", tags: { "risk": "medium" }, consequences: { trustChange: 5, supportChange: 5, bridgeResponse: "Un piloto... es mejor que nada, supongo. Es un enfoque metódico. Acepto. Próximo tema..." } },
          { option_id: "D", cardTitle: "Decision de Bajo Riesgo", cardEmoji: "🟢", text: "Enfoquémonos primero en tener la plataforma base funcionando. Podemos añadir la integración de redes sociales en la 'Fase 2' del proyecto.", tags: { "risk": "low" }, consequences: { trustChange: 0, supportChange: -5, bridgeResponse: "Siempre posponiendo... Entiendo la cautela, pero la oportunidad se nos puede escapar de las manos. Sigamos..." } }
        ]
      },
  {
      ...
      },
  {
        ...
        options: [
          { option_id: "A", cardTitle: "Rechazar Propuesta", cardEmoji: "⛔", text: "Imposible. Ana es crítica para nuestro primer sprint. No puedo cederla.", tags: { "risk": "low" }, consequences: { trustChange: -15, supportChange: -20, bridgeResponse: "Ok, me queda claro." } },
          { option_id: "B", cardTitle: "Aprobar Propuesta", cardEmoji: "✅", text: "Por supuesto. Una semana no es tanto. Somos un solo equipo. Ana estará con ustedes desde mañana.", tags: { "risk": "high" }, consequences: { trustChange: 15, supportChange: 15, projectProgressChange: -3, bridgeResponse: "Ok, me queda claro." } },
          { option_id: "C", cardTitle: "Decision de Riesgo Medio", cardEmoji: "🟡", text: "Puede ayudarlos, pero solo medio tiempo cada día. Es lo máximo que puedo ofrecer sin descarrilar mi propio proyecto.", tags: { "risk": "medium" }, consequences: { trustChange: 5, supportChange: 5, projectProgressChange: -1, bridgeResponse: "Ok, me queda claro." } },
          { option_id: "D", cardTitle: "Decision de Riesgo Medio", cardEmoji: "🟡", text: "La cederé, pero necesito que esto se formalice y que Ricardo (CFO) apruebe una extensión de una semana en mi plazo de entrega.", tags: { "risk": "medium" }, consequences: { trustChange: 10, supportChange: 10, bridgeResponse: "Ok, me queda claro." } }
        ]
      },
];
