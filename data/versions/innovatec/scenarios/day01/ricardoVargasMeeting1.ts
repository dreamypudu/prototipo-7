        ...
        options: [
          {
            ...
            consequences: { budgetChange: -500000, trustChange: 10, supportChange: 5, bridgeResponse: "Entendido. Una decisión conservadora. Lo aprecio. Al menos así todos sabemos a qué atenernos..." }
          },
          {
            ...
            consequences: { budgetChange: -800000, trustChange: 5, supportChange: 10, bridgeResponse: "Ambicioso. Espero que tu confianza esté bien fundada. Estaré observando esos hitos muy de cerca..." }
          },
          {
            ...
            consequences: { budgetChange: -600000, trustChange: 0, supportChange: 0, bridgeResponse: "Una negociación razonable. Me parece un buen equilibrio entre seguridad y ambición..." }
          },
          {
            ...
            consequences: { budgetChange: -300000, trustChange: -5, supportChange: -5, bridgeResponse: "Una solicitud directa. Lo consideraré, pero dependerá de la solidez de tus proyecciones..." }
          }
        ]
      },
  {
        ...
        options: [
          {
            ...
            consequences: { trustChange: 10, supportChange: 5, reputationChange: 5, bridgeResponse: "Como quieras. Más lento, pero entiendo tu apego a las reglas. Sigamos..." }
          },
          {
            ...
            consequences: { trustChange: -10, supportChange: 10, reputationChange: -10, bridgeResponse: "Bien. Veo que eres una persona pragmática que busca resultados. Me gusta. Sigamos..." }
          },
          {
            ...
            consequences: { trustChange: 15, supportChange: 5, reputationChange: 10, bridgeResponse: "Como quieras. Más lento, pero entiendo tu apego a las reglas. Sigamos..." }
          },
          {
            ...
            consequences: { trustChange: -5, supportChange: 5, reputationChange: -5, bridgeResponse: "Bien. Veo que eres una persona pragmática que busca resultados. Me gusta. Sigamos..." }
          }
        ]
      },
  {
        ...
        dialogue: "...Finalmente, el reporte de avances. Puedes enviarme un informe mensual detallado, con todas las métricas y desviaciones, lo que nos da tiempo para analizar. O, podemos tener una reunión semanal de 15 minutos, muy ejecutiva, donde me das los titulares. Más rápido, pero con menos detalle.",
          options: [
              { option_id: "A", cardTitle: "Definir Reporte", cardEmoji: "📊", text: "Prefiero el informe mensual detallado. La precisión y la profundidad en los datos son cruciales para el control financiero.", tags: { "risk": "low" }, consequences: { trustChange: 5, bridgeResponse: "De acuerdo. Prefiero tener todos los datos." } },
              { option_id: "B", cardTitle: "Decision de Alto Riesgo", cardEmoji: "🔴", text: "La reunión semanal es más ágil. Nos permite corregir el rumbo rápidamente si algo sale mal.", tags: { "risk": "high" }, consequences: { trustChange: -5, bridgeResponse: "De acuerdo. Seré breve, pero espero que seas preciso." } },
              { option_id: "C", cardTitle: "Definir Reporte", cardEmoji: "📊", text: "Hagamos la reunión semanal, pero que mi Project Manager te envíe además un resumen de métricas clave cada viernes.", tags: { "risk": "medium" }, consequences: { trustChange: 10, bridgeResponse: "De acuerdo. Es un buen sistema." } },
