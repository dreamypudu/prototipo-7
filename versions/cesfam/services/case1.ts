...
import { splitCanonicalActionValueFinal } from '../../../services/MechanicEngine';
import { buildSchedulerExecuteWeekValueFinal } from '../../../mechanics/scheduler/services/scheduleCanonicalExport';
import { getPhysicalConflictData } from '../../../mechanics/scheduler/services/scheduleConflicts';
...
const buildScheduleCanonicalAction = (state: GameState): CanonicalAction => {
  ...
  const split = splitCanonicalActionValueFinal(buildSchedulerExecuteWeekValueFinal(state, submittedAtMs));
