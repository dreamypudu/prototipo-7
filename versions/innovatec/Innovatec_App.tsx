            ...
            case 'confirm_schedule':
                if (stakeholderToSchedule && selectedSlot) {
                    ...
                    mechanicEngine.emitEvent('calendar', 'meeting_scheduled', {
                        ...
                        stakeholder_name: stakeholderToSchedule.name,
                    ...
                    mechanicEngine.emitCanonicalAction(
                        ...
                        {
                            target_type: 'npc',
                            target_id: stakeholderToSchedule.id,
                            target_label: stakeholderToSchedule.name,
                            day: selectedSlot.day,
                            time_slot: selectedSlot.slot,
                            committed_day: gameState.day,
                            committed_time_slot: gameState.timeSlot,
                            ...
                            summary: `Reunión agendada con ${stakeholderToSchedule.name}`,
                            mechanic_payload: {
                                npc_id: stakeholderToSchedule.id,
                                npc_name: stakeholderToSchedule.name,
                                npc_role: stakeholderToSchedule.role,
                                scheduled_day: selectedSlot.day,
                                scheduled_time_slot: selectedSlot.slot,
                                committed_day: gameState.day,
                                committed_time_slot: gameState.timeSlot,
                                preference: gameState.stakeholder_preferences[stakeholderToSchedule.id] ?? null,
                                scheduled_at_ms: scheduledAtMs
                            }
                        }
                    );
